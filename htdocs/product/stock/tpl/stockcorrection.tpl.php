...
/**
 * README : Montée de version Théoblad : en dehors des commentaires html de balisage,
...
<!-- BEGIN PHP TEMPLATE clitheobald/htdocs/product/stock/tpl/stockcorrection.tpl.php -->
...
if ($object->element == 'product')
{
	...
	if($object->element == 'product') {
		...
		$fk_default_warehouse = $dProductWarehouse->getWarehouseFromProduct($object, $conf->entity);
	}
	$finalSelectedWarehouse = (GETPOST("dwid") ?GETPOST("dwid", 'int') : (GETPOST('id_entrepot') ?GETPOST('id_entrepot', 'int') : ($object->element == 'product' && $fk_default_warehouse ? $fk_default_warehouse : 'ifone')));
	print $formproduct->selectWarehouses($finalSelectedWarehouse, 'id_entrepot', 'warehouseopen,warehouseinternal', 1, 0, 0, '', 0, 0, null, 'minwidth100');
...
<!-- END PHP TEMPLATE clitheobald/htdocs/product/stock/tpl/stockcorrection.tpl.php -->
